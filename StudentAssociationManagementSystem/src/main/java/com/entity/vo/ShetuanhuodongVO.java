...
public class ShetuanhuodongVO  implements Serializable {
	...
	public void setBaomingrenqun(String baomingrenqun) {
		this.baomingrenqun = baomingrenqun;
	}
	
	/**
	 * 获取：报名人群
	 */
	public String getBaomingrenqun() {
		return baomingrenqun;
	}
